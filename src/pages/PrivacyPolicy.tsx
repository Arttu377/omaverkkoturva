        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-600 mb-4">
                Tietoja säilytetään EU:n yleisen tietosuoja-asetuksen (GDPR) vaatimusten mukaisesti. Asiakastietoja käsitellään sisäisessä järjestelmässä sekä turvallisilla palvelimilla, joita tarjoavat Google ja Supabase inc.
              </p>
              ...
              <p className="text-gray-600 mb-4">
                Nämä jatkokäsittelyt liittyvät läheisesti edellä mainittuihin ensisijaisiin käyttötarkoituksiin ja tukevat asiakassuhteiden kehittämistä. Ne eivät aiheuta rekisteröidylle muita suoria vaikutuksia. Emme käsittele henkilötietoja muihin kuin tässä selosteessa kuvatuihin tarkoituksiin.
              </p>
              ...
              <p className="text-gray-600 mb-4">Tietoja voidaan kerätä myös seuraavin tavoin:</p>
              ...
              <p className="text-gray-600 mb-4">Henkilötietoja voidaan antaa seuraaville tahoille:</p>
              ...
              <p className="text-gray-600 mb-4">
                Defentry AB toimii osassa käsittelyä itsenäisenä rekisterinpitäjänä ja vastaa tällöin henkilötietojen käsittelystä omien käytäntöjensä mukaisesti. Lisätietoa heidän tietosuojakäytännöistään on saatavilla osoitteessa: <a href="https://tietosuoja.omaverkkoturva.fi/privacy_policy" target="_blank" rel="noopener noreferrer">tietosuoja.omaverkkoturva.fi/privacy_policy</a>
              </p>

              <p className="text-gray-600 mb-4">Jos tietoja siirretään EU-/ETA-alueen ulkopuolelle, siirto perustuu johonkin seuraavista laillisista perusteista:</p>
              ...
              <p className="text-gray-600 mb-4">
                Kaikkia henkilötietoja käsitellään ehdottoman luottamuksellisesti. Asiakas- ja henkilötiedot tallennetaan asiakkuudenhallintajärjestelmään ja niiden varmuuskopiot säilytetään OmaVerkkoturvan valitsemissa ulkopuolisten tahojen tarjoamissa tietokannoissa EU-alueella sijaitsevilla suojatuilla palvelimilla. Näihin tietokantoihin kuuluvat alla olevat järjestelmät:
              </p>

              <ul className="list-disc pl-6 mb-4 text-gray-600">
                <li>Cursor &amp; GitHub – verkkosivujen ja portaalien toteutus ja julkaisu.</li>
                <li>Supabase – asiakasportaalin ja verkkosivujen tietokantapalvelin.</li>
                <li>Ropo – laskutus ja maksujen käsittely.</li>
                <li>Lemonsoft CRM – asiakasrekisterin hallinta.</li>
                <li>Cookiebot – evästeiden hallinta ja suostumusten kerääminen.</li>
                <li>Resend &amp; EmailJS – sähköpostiviestien lähetys ja vastaanotto.</li>
                <li>SMS API – tekstiviestien lähetys asiakkaille.</li>
                <li>Microsoft – sähköpostit, dokumentit ja muu henkilötietojen käsittely.</li>
              </ul>

              <p className="text-gray-600 mb-4">
                Tietoihin on pääsy ainoastaan niillä henkilöillä, joiden työtehtävät sitä edellyttävät, ja käyttö tapahtuu henkilökohtaisilla tunnuksilla, kaksivaiheisella tunnistamisella ja salasanoilla.
              </p>
              ...
              <p className="text-gray-600 mb-4">Tietosuojalainsäädännön mukaisesti sinulla on oikeus:</p>
              ...
              <p className="text-gray-600 mb-6">Viimeisin päivitys: 18.9.2025.</p>

              <h3 className="text-xl font-semibold mt-6 mb-3">Yhteydenotot</h3>
              <p className="text-gray-600 mb-4">
                Kaikki tietosuojaselostetta ja henkilötietojen käsittelyä koskevat pyynnöt tulee toimittaa rekisterinpitäjälle sähköpostitse: arttu.simanainen@telendor.fi
              </p>
