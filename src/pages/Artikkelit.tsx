...
const Artikkelit = () => {
  ...
  return (
    <PageLayout>
      ...
      {/* Full width hero section (same as blog) */}
                   <FullWidthHero
               backgroundImage="/kuvapankki/Kappaleen teksti (92).png"
               title="Artikkeli"
               subtitle="Seuraa uusimpia artikkeleita tietoturvasta ja identiteettisuojasta."
               height="400px"
             />
      
      <div className="min-h-screen bg-gradient-to-b from-white via-blue-50 to-blue-100 pt-8 md:pt-16 pb-16">
