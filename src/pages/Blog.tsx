  ...
  return (
    <PageLayout>
      ...
      {/* Full width hero section */}
                   <FullWidthHero
               backgroundImage="/kuvapankki/Kappaleen teksti (93).png"
               title="Blogi"
               subtitle="Ajankohtaisia vinkkejä ja ohjeita identiteettisuojasta sekä verkkoturvallisuudesta. Pysy ajan tasalla tietoturvassa ja suojaa henkilötietojasi."
               height="400px"
             />
      

      
      <div className="min-h-screen bg-gradient-to-b from-white via-blue-50 to-blue-100 pt-8 md:pt-16 pb-8 md:pb-16">
